						...
						<form action="sign-up" method="post">
							<div class="form-floating mb-3">
								<input type="text" class="form-control"
									...
									required name="fullName" placeholder="name@example.com">
							...
							<div class="form-floating mb-3">
								<input type="password" class="form-control"
									...
									oninvalid="setCustomValidity('Minimum eight characters, at least one letter, one number and one special character')"
									required name="password" placeholder="Password"> <label
