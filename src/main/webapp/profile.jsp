...
<body>
    <div class="container rounded bg-white mt-5 mb-5">
        <div class="row">
        	<a href="home" style="text-decoration: none; color: #333;">
            ...
            <div class="col-md-3 border-right">
                <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                	<c:if test="${sessionScope.accountInfo.gender == 'Male'}">
                		<img class="rounded-circle mt-5" width="150px" src="images/man-profile.png">
                	</c:if>
                	<c:if test="${sessionScope.accountInfo.gender == 'Female'}">
                		<img class="rounded-circle mt-5" width="150px" src="images/woman-profile.png">
                	</c:if>
                	<c:if test="${sessionScope.accountInfo.gender == '' || sessionScope.accountInfo.gender == null}">
                    ...
                    <c:if test="${sessionScope.accountInfo.phoneNumber != null || sessionScope.accountInfo.phoneNumber != ''}">
                    	<span class="text-black-50">${sessionScope.accountInfo.phoneNumber}</span>
                    </c:if>	
                    <c:if test="${sessionScope.accountInfo.age > 0}">
                    	<span class="text-black-50">Age: ${sessionScope.accountInfo.age}</span>
                    </c:if>
                    <c:if test="${sessionScope.accountInfo.country != null || sessionScope.accountInfo.country != ''}">
                        <span class="text-black-50">Country: ${sessionScope.accountInfo.country}</span>
                    </c:if>
                    <c:if test="${sessionScope.accountInfo.address != null || sessionScope.accountInfo.address != ''}">
                        <span class="text-black-50">Address: ${sessionScope.accountInfo.address}</span>
                    </c:if>
                    ...
                    <div class="p-5 py-5">
                        ...
                        <div class="row mt-4">
                            <div class="col-md-9">
                                ...
                                <input type="text" pattern="^[a-zA-Z]+(([',. -][a-zA-Z ])?[a-zA-Z]*)*$" oninvalid="setCustomValidity('This name is not valid')" required name="fullName" class="form-control" placeholder="Full Name" value="${sessionScope.accountInfo.fullName}">
                            </div>
                            <div class="col-md-3">
                                <label class="labels">Gender</label>
                                <select class="form-select form-select-md form-control" name="gender">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                ...
                                <c:if test="${sessionScope.accountInfo.age > 0}">
                                	<input type="number" name="age" min="1" max="100" class="form-control" placeholder="age" value="${sessionScope.accountInfo.age}">
                                </c:if>
                                <c:if test="${sessionScope.accountInfo.age == 0}">
                                	<input type="number" name="age" min="1" max="100" class="form-control" placeholder="age" value="">
                                </c:if>
                            </div>
                        </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                ...
                                <select class="form-select form-select-md form-control" name="country" required>
                                    ...
                                    <option value="['Bonaire, Sint Eustatius and Saba','BQ']">"Bonaire, Sint Eustatius
                                        and
                                        Saba"
                                    </option>
                                    ...
                                    <option value="['South Georgia and the South Sandwich Islands','GS']">South Georgia
                                        and
                                        the
                        ...
                        <div class="row mt-4">
                            <div class="col-md-12">
                                ...
                                <input type="text" pattern="^[+]*[(]{0,1}[0-9]{1,4}[)]{0,1}[-\s\./0-9]*$" required name="phoneNumber" class="form-control" placeholder="enter phone number" value="${sessionScope.accountInfo.phoneNumber}">
                            </div>
                        </div>
                        <div class="row mt-4">
                            <div class="col-md-12">
                            	<label class="labels">Address</label>
                            	<input type="text" required name="address" class="form-control" placeholder="enter address" value="${sessionScope.accountInfo.address}">
                            </div>
                        </div>
