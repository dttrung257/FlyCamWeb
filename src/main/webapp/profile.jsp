...
<body>
	<div class="container rounded bg-white mt-5 mb-5">
		<div class="row">
			<a href="home" style="text-decoration: none; color: #333;"> <i
				class="fa-solid fa-arrow-left"></i> <span>Back to home</span>
			</a>
			<div class="col-md-3 border-right">
				<div
					class="d-flex flex-column align-items-center text-center p-3 py-5">
					<c:if test="${sessionScope.accountInfo.gender == 'Male'}">
						<img class="rounded-circle mt-5" width="150px"
							src="images/man-profile.png">
					</c:if>
					<c:if test="${sessionScope.accountInfo.gender == 'Female'}">
						<img class="rounded-circle mt-5" width="150px"
							src="images/woman-profile.png">
					</c:if>
					<c:if
						test="${sessionScope.accountInfo.gender == '' || sessionScope.accountInfo.gender == null}">
						<img class="rounded-circle mt-5" width="150px"
							src="images/profile.jpg">
					</c:if>
					<span class="font-weight-bold">${sessionScope.accountInfo.fullName}</span>
					<span class="text-black-50">${sessionScope.accountInfo.email}</span>
					<c:if
						test="${sessionScope.accountInfo.phoneNumber != null || sessionScope.accountInfo.phoneNumber != ''}">
						<span class="text-black-50">${sessionScope.accountInfo.phoneNumber}</span>
					</c:if>
					<c:if test="${sessionScope.accountInfo.age > 0}">
						<span class="text-black-50">Age:
							${sessionScope.accountInfo.age}</span>
					</c:if>
					<c:if
						test="${sessionScope.accountInfo.country != null || sessionScope.accountInfo.country != ''}">
						<span class="text-black-50">Country:
							${sessionScope.accountInfo.country}</span>
					</c:if>
					<c:if
						test="${sessionScope.accountInfo.address != null || sessionScope.accountInfo.address != ''}">
						<span class="text-black-50">Address:
							${sessionScope.accountInfo.address}</span>
					</c:if>
			...
			<div class="col-md-7 border-right">
				<form action="update-profile" method="post">
					<div class="p-5 py-5">
						...
						<div class="row mt-4">
							<div class="col-md-9">
								<label class="labels">Full Name</label> <input type="text"
									...
									oninvalid="setCustomValidity('This name is not valid')"
									required name="fullName" class="form-control"
									placeholder="Full Name"
									value="${sessionScope.accountInfo.fullName}">
							</div>
							<div class="col-md-3">
								<label class="labels">Gender</label> <select
									class="form-select form-select-md form-control" name="gender">
							...
							<div class="col-md-12">
								...
								<c:if test="${sessionScope.accountInfo.age > 0}">
									<input type="number" name="age" min="1" max="100"
										...
										value="${sessionScope.accountInfo.age}">
								</c:if>
								<c:if test="${sessionScope.accountInfo.age == 0}">
									<input type="number" name="age" min="1" max="100"
						...
						<div class="row mt-3">
							<div class="col-md-12">
								<label class="labels">Country</label> <select
									class="form-select form-select-md form-control" name="country"
									required>
									<option value="">Select Country</option>
									<option value="['Nigeria','NG']">Nigeria</option>
									<option value="['Afghanistan','AF']">Afghanistan</option>
									<option value="['Ãƒâ€¦land Islands','AX']">Ãƒâ€¦land
										Islands</option>
									...
									<option value="['Antigua and Barbuda','AG']">Antigua
										and Barbuda</option>
									...
									<option value="['Bosnia and Herzegovina','BA']">Bosnia
									...
									<option value="['British Indian Ocean Territory','IO']">British
									...
									<option value="['Christmas Island','CX']">Christmas
										Island</option>
									<option value="['Cocos (Keeling) Islands','CC']">Cocos
									...
									<option value="['CÃƒÂ´te d'Ivoire','CI']">CÃƒÂ´te
										d'Ivoire</option>
									...
									<option value="['Falkland Islands (Malvinas)','FK']">Falkland
									...
									<option value="['French Polynesia','PF']">French
										Polynesia</option>
									<option value="['French Southern Territories','TF']">French
									...
									<option value="['Holy See (Vatican City State)','VA']">Holy
									...
									<option value="['Iran, Islamic Republic of','IR']">"Iran,
									...
									<option value="['Korea, Republic of','KR']">"Korea,
										Republic of"</option>
									<option value="['Kuwait','KW']">Kuwait</option>
									<option value="[Kyrgyzstan','KG']">yrgyzstan</option>
									<option value="['Lao People`s Democratic Republic','LA']">Lao
									...
									<option
										value="['Macedonia, the Former Yugoslav Republic of','MK']">"Macedonia,
									...
									<option value="['Moldova, Republic of','MD']">"Moldova,
										Republic of"</option>
									...
									<option value="['Northern Mariana Islands','MP']">Northern
									...
									<option value="['Palestine, State of','PS']">"Palestine,
										State of"</option>
									...
									<option value="['Saint BarthÃƒÂ©lemy','BL']">Saint
										BarthÃƒÂ©lemy</option>
									<option
										value="['Saint Helena','Ascension and Tristan da Cunha','SH']">"Saint
										Helena, Ascension and Tristan da Cunha"</option>
									<option value="['Saint Kitts and Nevis','KN']">Saint
										Kitts and Nevis</option>
									<option value="['Saint Lucia','LC']">Saint Lucia</option>
									<option value="['Saint Martin (French part)','MF']">Saint
										Martin (French part)</option>
									<option value="['Saint Pierre and Miquelon','PM']">Saint
									...
									<option value="['Sao Tome and Principe','ST']">Sao
									...
									<option value="['Svalbard and Jan Mayen','SJ']">Svalbard
									...
									<option value="['Syrian Arab Republic','SY']">Syrian
										Arab Republic</option>
									<option value="['Taiwan, Province of China','TW']">"Taiwan,
									...
									<option value="['Trinidad and Tobago','TT']">Trinidad
										and Tobago</option>
									...
									<option value="['Turks and Caicos Islands','TC']">Turks
									...
									<option value="['United Arab Emirates','AE']">United
									...
									<option value="['Virgin Islands, British','VG']">"Virgin
										Islands, British"</option>
									<option value="['Virgin Islands, U.S.','VI']">"Virgin
										Islands, U.S."</option>
									<option value="['Wallis and Futuna','WF']">Wallis and
										Futuna</option>
						...
						<div class="row mt-4">
							<div class="col-md-12">
								<label class="labels">Phone Number</label> <input type="text"
									...
									value="${sessionScope.accountInfo.phoneNumber}">
							</div>
						</div>
						<div class="row mt-4">
							<div class="col-md-12">
								<label class="labels">Address</label> <input type="text"
									...
									value="${sessionScope.accountInfo.address}">
							</div>
						</div>
